...
class Tech extends Component {
    ...
    componentDidMount() {
        fetch('http://newsapi.org/v2/top-headlines?country=gb&category=technology&apiKey=26c8bdd6cb72495685575001723f30af')
    ...
    searchByKeyword = () => {
        fetch(`http://newsapi.org/v2/top-headlines?country=gb&q=${this.state.input}&category=technology&apiKey=26c8bdd6cb72495685575001723f30af`)
            .then(response => response.json())
            .then(json => {
                this.setState({ data: json.articles });
                console.log(json.articles)
    ...
    showUSNews = () => {
        fetch(`http://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=26c8bdd6cb72495685575001723f30af`)
            .then(response => response.json())
            .then(json => {
                this.setState({ data: json.articles });
                console.log(json.articles)
